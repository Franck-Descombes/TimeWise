...
export class LoaderService {
  ...
  // Modifie l’état des données, en passant true / false à l’Observable isLoading$. 
  // la méthode next() est liée aux Observables et permet d’émettre une nouvelle valeur dans le flux.
