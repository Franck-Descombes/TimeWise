export class User {
  ...
  // Utilisé pour accéder à une propriété d'un objet potentiellement null ou undefined, sans provoquer d'erreur de type "Cannot read property 'x' of null" ou "Cannot read property 'x' of undefined".
  constructor(
    options: {
      id?: string;
      email?: string;
  ...
  get roles(): string[] {
    // Les rôles sont représentés par un tableau de string.
    return this.email.endsWith('google.com') ? ['USER', 'EMPLOYEE'] : ['USER'];
  }

  // vérifier que l’utilisateur a bien tel ou tel rôle.
